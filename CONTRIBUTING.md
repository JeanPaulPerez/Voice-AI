...
Thank you for your interest in contributing to Voice AI! This guide will help you get started with contributing to this open source speech-to-text application.

## ⚠️ Feature Freeze

**Voice AI is currently undergoing a feature freeze.** If you are submitting a PR which is a new feature that the community has not asked for, it will be rejected. If the community has asked for it, or you have explicitly gathered support, it may still be considered.
...
Voice AI aims to be the most forkable speech-to-text app. The goal is to create both a useful tool and a foundation for others to build upon—a well-patterned, simple codebase that serves the community. We prioritize:
...
2. **Clone your fork**:
   ...
   ```bash
   git clone git@github.com:YOUR_USERNAME/Voice AI.git
   cd Voice AI
   ```
...
Voice AI follows a clean architecture pattern:
...
4. Describe your feature idea including:
   ...
   - How it fits with Voice AI's philosophy
...
3. **Get community feedback for features** - PRs with demonstrated community interest are **much more likely to be merged**. Start a discussion, get feedback, and link to it in your PR. This helps ensure Voice AI stays focused and useful for the most people without becoming bloated.

Community feedback is essential to keeping Voice AI the best it can be for everyone. It helps prioritize what matters most and prevents feature creep.
...
By contributing to Voice AI, you agree that your contributions will be licensed under the MIT License. See [LICENSE](LICENSE) for details.

---

**Thank you for contributing to Voice AI!** Your efforts help make speech-to-text technology more accessible, private, and extensible for everyone.
