...
/// and `Dark` force one of the two palettes Voice AI ships.
#[derive(Serialize, Deserialize, Debug, Clone, Copy, PartialEq, Eq, Type)]
#[serde(rename_all = "snake_case")]
pub enum Theme {
    System,
...
fn default_theme() -> Theme {
    // Voice AI's identity is the dark palette — neon blue on black — so it is
    // what a fresh install gets regardless of the OS setting. `System` and
    // `Light` remain selectable in Settings.
    Theme::Dark
}
