...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::save_overlay_custom_position,
            shortcut::reset_overlay_custom_position,
    ...
    // Single-instance forwards CLI args to an already-running Voice AI and exits.
