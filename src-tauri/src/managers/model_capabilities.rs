//! Model capability probing — the seam between Voice AI's model UI and "what can
...
/// How confident we are that Voice AI can run a given model, judged from its GGUF
